...
<template>
  <el-menu
    ...
    class="menu--no-group-title h-full"
  >
    <!-- 返回 -->
    <el-menu-item class="border-none">
    ...
    <template v-for="(parent, index) in FEATURE_SETTING" :key="parent.name">
      <!-- 第一層選單，有子層 -->
